...
{
    public partial class Equipos_2 : Form
    {
        public Equipos_2()
        {
            InitializeComponent();
        ...
        private void NuevoEquipo()
        {
            ...
            try
            {
                ...
                MessageBox.Show("Equipo agregado agregado.");
                conectionDatabase.Close();
            }
            catch (Exception ex)
            {
        ...
        private void Equipos_2_Load(object sender, EventArgs e)
        {
            string connection = "datasource=localhost;port=3306;username=root;password=;database=xray";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            if (textBox1.Text == "")
            {
                MessageBox.Show("Falta nombre del equipo");
            }
            else if (textBox3.Text == "")
            {
                MessageBox.Show("Falta marca");
            }
            else if (textBox4.Text == "")
            {
                MessageBox.Show("Falta modelo");
            }
            else if (textBox5.Text == "")
            {
                MessageBox.Show("Falta Estado del Equipo");
            }
            else if (textBox6.Text == "")
            {
                MessageBox.Show("Falta tipo de equipo");
            }
            else
            {
                NuevoEquipo();
